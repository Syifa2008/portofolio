...
<head>
    ...
    font-weight: 600;
    color: #FFC0CB; /* Pink pastel */
    text-shadow: 0 0 10px rgba(255, 105, 180, 0.7), 0 0 30px rgba(255, 105, 180, 0.3);
    text-align: center;
    font-size: 50px;
        }
        ...
        /* Header */
        header {
            background-color: ; /* Semi-transparent header */
            color: #FFC0CB;
            padding: 120px 20px;
            text-align: center;
        ...
        nav ul li a:hover {
            color: #FFC0CB; /* Slightly darker green for hover effect */
    ...
    <section id="certificates" class="certificates">
        ...
        <div class="certificate-card-container">
            ...
            <div class="certificate-card">
                <img src="{{ asset($cert->file) }}" alt="Certificate">
                <h3>{{$cert->name}}</h3>
                <p>{{$cert->issued_by}}</p>
                <p>{{$cert->issued_at}}</p>
