...
<head>
    ...
    <style>
        ...
        .container {
            ...
            border: 1px solid #FFB6C1; /* Pink pastel border */
            border-radius: 15px;
            box-shadow: 0 4px 20px rgba(255, 182, 193, 0.5); /* Pinkish glow */
            padding: 40px;
            max-width: 500px;
            width: 100%;
        }
        ...
        h1 {
            ...
            text-align: center;
            margin-bottom: 30px;
            text-shadow: 2px 2px 8px rgba(255, 182, 193, 0.7); /* Glow effect */
        }
        ...
        .form-control:focus {
            outline: none;
            border-color: #FF69B4; /* Darker pink on focus */
            box-shadow: 0 0 8px rgba(255, 182, 193, 0.8); /* Glow effect */
        }
