...
<head>
    ...
    body {
        ...
        background: linear-gradient(135deg, #a3c8f1, #f7c6d4); /* Light Blue and Pink Pastel Gradient Background */
        margin: 0;
        padding: 0;
    ...
    .container {
        ...
        margin: 50px auto;
        padding: 50px;
        background-color: #f7c6d4; /* White background */
        border-radius: 20px;
    ...
    .container::before {
        ...
        right: -10px;
        bottom: -10px;
        background: rgba(255, 182, 193, 0.1); /* Soft Pink Glow */
        border-radius: 20px;
        z-index: -1;
    }
    ...
    h1 {
        text-align: center;
        color: #2196F3; /* Light Blue for heading */
        font-size: 40px;
        font-weight: 700;
        margin-bottom: 30px;
    }
    ...
    th {
        background-color: lightblue; /* Light Pastel Yellow for header */
        color: black;
        font-weight: 700;
    }
    ...
    .btn-warning {
        background-color: #FFB6C1; /* Pastel Pink for Warning */
        color: #333;
    }

    .btn-warning:hover {
        background-color: #FF8C94; /* Slightly darker Pink */
    }
            ...
            <table id="skillsTable" class="table display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($certif->file)
                            <a href="{{ asset($certif->file) }}" target="_blank" class="file-link">View Certificate</a>
                            @else
                            No file uploaded
                            @endif
                        </td>
                        <td>
                            <a href="{{ route('admin.certificate.certifedit', $certif) }}" class="btn btn-warning">
