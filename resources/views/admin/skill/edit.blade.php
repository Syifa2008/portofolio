...
<head>
    ...
    <style>
        body {
            background-color: #ffd1dc; /* Warna latar belakang pink pastel */
            color: #1f4e78; /* Warna teks biru navy */
        ...
        .container {
            ...
            background-color: #ffe4e9; /* Latar belakang kontainer pink lebih terang */
            border-radius: 10px; /* Sudut melengkung */
            padding: 40px; /* Padding di dalam kontainer */
            box-shadow: 0 5px 30px rgba(0, 0, 0, 0.2); /* Bayangan lembut */
        ...
        h1 {
            ...
            color: #87cefa; /* Warna biru untuk judul */
        ...
        .form-label {
            ...
            color: #87cefa; /* Warna label biru navy */
        }

        .form-control {
            background-color: #ffffff; /* Latar belakang input */
            color: #87cefa; /* Warna teks input */
            border: 1px solid #87cefa; /* Warna border biru navy */
        ...
        .form-control::placeholder {
            color: #a3a3a3; /* Warna placeholder abu-abu */
        }

        .form-control:focus {
            border-color: #87cefa; /* Warna border saat fokus */
            outline: none; /* Menghilangkan outline default */
            background-color: #ffeef2; /* Warna latar saat fokus */
        }

        .btn-success {
            background-color: #87cefa; /* Warna tombol biru navy */
            ...
            box-shadow: 0 4px 20px rgba(0, 0, 0, 0.2); /* Bayangan tombol */
        }

        .btn-success:hover {
            background-color: #163d5a; /* Warna tombol saat hover lebih gelap */
            transform: translateY(-2px); /* Efek angkat saat hover */
            box-shadow: 0 6px 24px rgba(0, 0, 0, 0.3); /* Bayangan saat hover */
        }
