...
use App\Http\Controllers\Admin\AdminCertificateController;  // Pastikan ini menggunakan namespace yang benar
...
use App\Http\Controllers\HomeController; // Perbaiki penggunaan HomeController
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    // Admin Certificate routes (fixed to use correct controller and route)
    Route::resource('admin/certificates', AdminCertificateController::class)
        ->names([
            'index' => 'admin.certificate.index',
            'create' => 'admin.certificate.create',
            'store' => 'admin.certificate.store',
            'show' => 'admin.certificate.show',
            'edit' => 'admin.certificate.certifedit',
